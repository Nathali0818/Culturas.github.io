...
<HTML lang="es"><!--HTML es la etiqueta raíz, lang indica el lenguaje "es" de español-->
    ...
    <body><!-- inicia el cuerpo del documento-->
          ...
          <header><!--cabecera-->
            <p>
                <h1> <!--titulo de la pag-->
                <img src="img/logo.png" class="imagen-inline"> </p>
                RAMOS LOPEZ </h1>
            </header>
          ...
          <article class ="articulo"><h2> Cultura mexicana  </h2><!--titulo del articulo-->
            ...
            <aside class="programada">
                <h3>
                    <img src="img/imgP.jpeg" class="imagen-inline">
                 <img src="img/imgP2.jpeg" class="imagen-inline">
                  <img src="img/imganuncio.jpeg" class="imagen-inline">
           ...
           La cultura mexicana es rica y diversa, con influencias indígenas, coloniales, afrodescendientes, y modernas, lo que le da una complejidad única.
                 ...
                 </p><!--informacion cpmplementaria-->
                 <aside class="programada">
                    <h4>
                 <img src="img/imgP3.jpeg" class="imagen-inline">
                 <img src="img/imgP4.jpeg" class="imagen-inline">
                  <img src="img/imgP5.jpeg" class="imagen-inline">
                   <img src="img/imgP6.jpeg" class="imagen-inline">
                  
                    
                    </h4>
                    <aside class="programada">
                        <h5> 
                            <img src="img/imganuncio2.jpeg" class="imagen-inline">
                        </h5>
            </aside>
